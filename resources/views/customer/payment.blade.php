                        ...
                        <form action="{{route('payment_store')}}" method="POST"
                            ...
                            <div class="mb-6 grid grid-cols-2 gap-4">
                                <div class="col-span-2 sm:col-span-1">
                                    <label for="full_name"
                                           class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Full
                            ...
                            <div
                                ...
                                <div class="space-y-2">
                                    ...
                                    <dl class="flex items-center justify-between gap-4">
                                        <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Original</dt>
                                        <dd class="text-base font-medium text-green-500"> ${{$money}}</dd>
                                    </dl>
                                </div>
